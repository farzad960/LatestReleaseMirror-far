...
🔗 [source](https://github.com/MHSanaei/3x-ui) – [<code><small>v3.2.8</small></code>](https://github.com/MHSanaei/3x-ui/releases/tag/v3.2.8)

| File | Size | Download |
|------|------|----------|
| `x-ui-linux-amd64.tar.gz` | 72.9 MB | [⬇️ Download](https://raw.githubusercontent.com/farzad960/LatestReleaseMirror-far/main/releases/MHSanaei/3x-ui/x-ui-linux-amd64.tar.gz) |
