...
🔗 [source](https://github.com/MHSanaei/3x-ui) – [<code><small>v3.5.0</small></code>](https://github.com/MHSanaei/3x-ui/releases/tag/v3.5.0)

| File | Size | Download |
|------|------|----------|
| `x-ui-linux-amd64.tar.gz` | 79.5 MB | [⬇️ Download](https://raw.githubusercontent.com/farzad960/LatestReleaseMirror-far/main/releases/MHSanaei/3x-ui/x-ui-linux-amd64.tar.gz) |
...
🔗 [source](https://github.com/themadorg/madmail) – [<code><small>v2.9.0</small></code>](https://github.com/themadorg/madmail/releases/tag/v2.9.0)

| File | Size | Download |
|------|------|----------|
| `madmail-linux-amd64.tar.gz` | 23.7 MB | [⬇️ Download](https://raw.githubusercontent.com/farzad960/LatestReleaseMirror-far/main/releases/themadorg/madmail/madmail-linux-amd64.tar.gz) |
