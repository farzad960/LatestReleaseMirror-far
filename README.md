...
| File | Size | Download |
|------|------|----------|
| `v2rayNG_2.2.2-fdroid_arm64-v8a.apk` | 27.0 MB | [⬇️ Download](https://raw.githubusercontent.com/farzad960/LatestReleaseMirror-far/main/releases/2dust/v2rayNG/v2rayNG_2.2.2-fdroid_arm64-v8a.apk) |
| `v2rayNG_2.2.2_arm64-v8a.apk` | 27.0 MB | [⬇️ Download](https://raw.githubusercontent.com/farzad960/LatestReleaseMirror-far/main/releases/2dust/v2rayNG/v2rayNG_2.2.2_arm64-v8a.apk) |
...
🔗 [source](https://github.com/MHSanaei/3x-ui) – [<code><small>v3.2.6</small></code>](https://github.com/MHSanaei/3x-ui/releases/tag/v3.2.6)

| File | Size | Download |
|------|------|----------|
| `x-ui-linux-amd64.tar.gz` | 73.0 MB | [⬇️ Download](https://raw.githubusercontent.com/farzad960/LatestReleaseMirror-far/main/releases/MHSanaei/3x-ui/x-ui-linux-amd64.tar.gz) |
...
🔗 [source](https://github.com/themadorg/madmail) – [<code><small>v2.2.2</small></code>](https://github.com/themadorg/madmail/releases/tag/v2.2.2)

| File | Size | Download |
|------|------|----------|
| `madmail-linux-amd64.tar.gz` | 18.8 MB | [⬇️ Download](https://raw.githubusercontent.com/farzad960/LatestReleaseMirror-far/main/releases/themadorg/madmail/madmail-linux-amd64.tar.gz) |
